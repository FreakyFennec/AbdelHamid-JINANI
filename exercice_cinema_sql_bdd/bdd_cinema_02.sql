...
-- Listage de la structure de la base pour cinema_hamid_02
CREATE DATABASE IF NOT EXISTS `cinema_hamid_02` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cinema_hamid_02`;

-- Listage de la structure de table cinema_hamid_02. acteur
...
-- Listage des données de la table cinema_hamid_02.acteur : ~43 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. appartenir
...
-- Listage des données de la table cinema_hamid_02.appartenir : ~10 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. casting
...
-- Listage des données de la table cinema_hamid_02.casting : ~46 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. film
...
-- Listage des données de la table cinema_hamid_02.film : ~10 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. genre
...
-- Listage des données de la table cinema_hamid_02.genre : ~16 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. personne
...
-- Listage des données de la table cinema_hamid_02.personne : ~49 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. realisateur
CREATE TABLE IF NOT EXISTS `realisateur` (
  `id_realisateur` int NOT NULL AUTO_INCREMENT,
  `id_personne` int NOT NULL,
  PRIMARY KEY (`id_realisateur`),
  KEY `FK_realilsateur_cinema_hamid_02.personne` (`id_personne`),
  CONSTRAINT `FK_realilsateur_cinema_hamid_02.personne` FOREIGN KEY (`id_personne`) REFERENCES `personne` (`id_personne`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=UTF8MB4;

-- Listage des données de la table cinema_hamid_02.realisateur : ~7 rows (environ)
...
-- Listage de la structure de table cinema_hamid_02. role
...
-- Listage des données de la table cinema_hamid_02.role : ~46 rows (environ)
