...
<body>
    <div class="container">
        ...
        <main>
            <h2>Exo PHP 02</h2>
            <section>
                <h3>exo_V2_13_classe_setter_getter.php</h3>

                    <p>Créer  une  classe  Voiture  possédant  les  propriétés  suivantes : marque,  modèle,  nbr portes et vitesse actuelle ainsi que les méthodes demarrer( ), accelerer( ) et stopper( ) en plus des  accesseurs  (get)  et  mutateurs  (set)  traditionnels.  <br>
