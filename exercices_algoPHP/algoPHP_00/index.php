...
<body>
    <div class="container">
        ...
        <main>
            ...
            <h2>Exo POO 02 Introduction PHP</h2>
            ...
            <section>
            <h3>Fonctions sur les chaîne de caractères</h3>                       
            <?php
            ...
            <section>
            <h3>Opération sur les tableaux</h3>                       
            <?php
            ...
            // Le texte est converti en nombre
            $texte = "Texte";
            $calcul = intval($texte) - 5;
            echo $calcul."<br>";
            ...
            <section>
            <h3>Structures de contrôle ( if )</h3>                       
            <?php
            ...
            */
            ...
            echo "<h4>Méthode for</h4>";
            for ($i = 0; $i < $nbMarques; $i++) { 
                echo $marques[$i]."<br>";
            }

            echo "<h4>Méthode while</h4>";
            $i = 0;
            while($i < $nbMarques) {
                echo $marques[$i]."<br>";
                $i++;
            ...
            <section>
            <h3>Les tabeleaux associatifs</h3>                       
            <?php
