...
class Auteur {
    ...
    public function afficherBibliographie() {
        $result = "<div class='authorAndBook'><div class='authorArea'>Livres de : $this</div><div class='bookArea'>";
        foreach ($this->livres as $livre) {
            $result .= "<p class='bookDetail'>$livre</p>";
        }
        $result .= "</div>";
    ...
    public function getTotalPriceBibliographie() {
        ...
        return "<p class='bookTotal'>Total de la bibliographie de ".$this->prenom." ".$this->nom." : $result €</p></div>";
    }
